...
tags: SpaceYExpanded,release-notes,kerbal,ksp,zer0Kerbal,zedK
layout: page
---
...
<b>For best results - DO A CLEAN INSTALL; DELETE EXISTING INSTALLATION THEN RE-INSTALL</b></h4><p>Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/SpaceYExpanded/files">CurseForge</a></p></div>
...
* Issues
  * closes #1 - SpaceY Expanded (SYE)-adoption `<Thank you NecroBones>` edition
  * closes #2 - Create Legal Mumbo Jumbo
  * closes #3 - Create Documentation
  * closes #4 - Create Social Media Presence
...
[forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/209445-*/ "SpaceYExpanded forum thread"
...
<!-- shields -->
[shd:stat]: https://img.shields.io/badge/SpaceY%20Lifters%20(SYL)%20-v1.4.99.0--adoption-BADA55.svg?style=plastic&labelColor=darkgreen/ "1.4.99.0-adoption"
...
[AVCVAL:shd]: https://github.com/zer0Kerbal/SpaceYExpanded/actions/workflows/AVC-VersionFileValidator.yml/badge.svg?style=plastic&labelColor=black "AVC Valid"
