...
| github     | (https://github.com/zer0Kerbal/zer0Kerbal/SpaceYExpanded)          |
...
* Issues
  ...
  * closes #99 - SpaceY Expanded (SYE) 1.9.99.1-prerelease `<Thank you NecroBones>` edition
...
* Issues
  * closes #40 - SpaceYExpanded (SYL) 1.9.99.0-adoption `<Thank you NecroBones>` edition
